...
<body>
  ...
  <a id="bookNow" class="navbar-brand   m-md-5" href="book.html">Book Now</a>
  </nav
  ...
  <nav>
    <div id="navbar2" class="navbar-collapse collapse fixed-left text-center">
      <ul id="main-menu" class="navbar-nav">
        ...
        <li class="nav-item">
          <a href="Login/Register.html" class="nav-link">Login/Register</a>
        </li>
        <li class="nav-item">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <div style="color: white">
            ...
            <a target="_blank" href="https://wwww.instagram.com">
